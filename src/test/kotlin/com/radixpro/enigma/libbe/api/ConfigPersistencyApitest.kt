...
class ConfigPersistencyApitest {
    ...
    private val configUpdate = Config(2, "Update", "descr-updated", Ayanamshas.NONE,
        HouseSystems.ALCABITIUS, ObserverPos.TOPOCENTRIC, celPoints, aspects, 8.0, 1.6, 2.0, 1.0)
